...
namespace App_ARRIENDA_BICIS
{
    public class Conexion
    {
        ...
        // TODA LA CONEXION DIRECTA CON LA BASE DE DATOS -----
        public Conexion()
        {
        ...
        private bool GenerarCadenaConexion()
        {
            ...
            strCadenaCnx = ConfigurationManager.ConnectionStrings["conexion"].ConnectionString;
            return true;
        }
        ...
        // TODOS LOS PROCEDIMIENTOS AL EJECUTARCE GUARDAR ELIMINAR ACTUALIZAR
        ...
        //METODO LISTAR LLENAR EL DATA SET --------------------------------
